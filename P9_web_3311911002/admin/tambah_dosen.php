...
<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
  ...
  <div class="form-row"> 
     <div class="form-group col-md-4"> 
      <label >NIDN</label> 
       <input type="text" name="nidn" class="form-control" id="nim"> 
    </div> 
   </div> 
    <div class="form-row"> 
 ...
 <div class="form-row"> 
     <div class="form-group col-md-6"> 
      <label >ALAMAT</label> 
       <input type="text" name="alamat" class="form-control" id="alamat">     </div> 
  </div> 
 <div class="form-row"> 
    <div class="form-group col-md-6"> 
      <label >Jabatan</label> 
      <input type="text" name="jabatan" class="form-control" id="jurusan">     </div> 
  </div> 
