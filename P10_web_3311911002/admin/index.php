...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
      <a class="navbar-brand" href="#">SELAMAT DATANG <?php $user ?></a>
...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-user-graduate mr-2"></i> Daftar Mahasiswa</h3><hr>
        <a href="tambah_mhs.php" class="btn btn-primary mb-2"> <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA MAHASISWA</a>
        ...
        <tbody>
          ...
          ?>
              ...
              <td>
                ...
                <a href="delete_mhs.php?nim=<?php echo $data['nim'];?>">Delete</a>
              </td>
              </tr>
              <?php
            }
